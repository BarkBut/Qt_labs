...
/// Теперь метод вместо вывода на экран возвращает строку
std::string Book::writeBook() {     // этот метод выводит книгу на экран 
    return getTitle() + std::string(",   ")
           + getAuthor() + std::string(",   ")
           + std::to_string(getPages()) + std::string("\n");
}
