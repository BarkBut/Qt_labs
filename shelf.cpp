...
/// todo исправить else -- убрать вывод в консоль ////////////////////////////////////////////////////////////////////
...
/// Этот метод больше ничего не выводит, он возвращает строку
std::string Shelf::writeShelf() {
    std::string all = "";
    int c = 0;
...
/// Этот метод больше не принимает номер полки
/// todo исправить проклятый вывод в консоль!!!!!! >:( /////////////////////////////////////////////////////////////
