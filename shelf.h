...
public:
    ...
    /// этот метод больше не требует номер полки (хз зачем у него это вообще раньше было)
    ...
    /// Этот метод больше ничего не выводит на экран, только возвращает строку
    std::string writeShelf();                     // этот метод выводит содержимое полки
